...
### Percobaan yang gagal: membuang penilaian jarak dari perutean

Diminta: gaya garis harus seragam berapa pun jarak antar lampunya, karena dua ruangan
dengan isi yang sama tampak bergaya berbeda. Diukur dan benar — dua ruangan yang
**identik** sudah menghasilkan garis identik, bahkan dengan geseran acak ±150 mm, jadi
yang menggeser gaya adalah jarak yang tidak seragam. Penilaian rute memakai panjang dan
impitan, keduanya dalam milimeter, jadi begitu kolom tidak sama lebar pemenangnya
berganti.

Percobaannya: buang penilaian jarak seluruhnya, ganti dengan aturan tetap — arah tengah
ruangan lebih dulu, lebar lajur menurut nomor kaki, dan jarak hanya memveto rute yang
menembus lampu. Diukur dengan tanda tangan gaya (urutan lampu, tiap lompatan memutar
atau tidak, ke sisi mana), lima ruangan berjarak sangat berbeda menghasilkan gaya yang
sama persis. Syaratnya terpenuhi.

**Dan hasilnya lebih buruk.** Garis jadi menumpuk dan saling menyilang di tengah ruangan.
Dua sebab, keduanya terlewat saat itu:

Membuang penilaian impitan berarti membuang satu-satunya mekanisme yang menjaga kedua
kaki tidak berjalan berdampingan. Lajur bernomor menjaga jarak keduanya di lompatan yang
sejenis, tapi tidak tahu apa-apa tentang ruas lain yang kebetulan lewat situ.

Dan mendahulukan arah tengah membuat putaran masuk ke dalam ruangan, tempat garis kaki
lain berada. Sisi luar didahulukan bukan karena selera melainkan karena di luar tidak ada
lalu lintas — itu tertulis di komentarnya, dan tetap saya balik.

Jadi dikembalikan. Yang perlu diingat kalau dicoba lagi: keseragaman dan tidak-menumpuk
saling tarik di desain sekarang, karena yang satu menuntut keputusan tanpa ukuran dan yang
lain menuntut tahu di mana garis lain berada. Jalan keluarnya bukan membuang penilaian
impitan, melainkan menyatakan lajur di ruang petak — nomor lajur per kolom petak, bukan
jarak milimeter — supaya dua ruas tidak akan pernah bisa memilih lajur yang sama tanpa
perlu mengukurnya. Itu perombakan `routeAvoiding` dan `aroundRoute`, bukan penyetelan.
