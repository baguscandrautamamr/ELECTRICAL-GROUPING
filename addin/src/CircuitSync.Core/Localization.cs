...
public static class Translations
{
    public static readonly IReadOnlyDictionary<string, string> Id = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["action.auto_push"] = "Kirim ulang model sendiri saat ada perubahan",
        ...
        ["log.wiring_replaced"] = "Garis wiring diganti: {0} kaki saklar, {1} ruas baru, {2} ruas lama dihapus",
        ["log.wiring_untracked"] = "Garis wiring tidak tercatat karena tabel wiring_curves belum ada, jadi kiriman berikutnya akan menumpuk. Jalankan migrasi terbaru (supabase db push).",
    ...
    public static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["action.auto_push"] = "Push the model again by itself when it changes",
        ...
        ["log.wiring_replaced"] = "Wiring replaced: {0} switch legs, {1} new segments, {2} old segments removed",
        ["log.wiring_untracked"] = "The wiring was not recorded because the wiring_curves table does not exist yet, so the next send will stack on top of it. Run the latest migration (supabase db push).",
